...
final class HuntCoreTests: XCTestCase {
    func testDistanceDoesNotTreatDifferentLongitudesAsSameLocation() {
        XCTAssertEqual(Geo.distance(lat1: 59.3326, lon1: 18.0649, lat2: 59.3326, lon2: 18.0649), 0, accuracy: 0.001)
        XCTAssertGreaterThan(Geo.distance(lat1: 59.3326, lon1: 18.0649, lat2: 59.3326, lon2: 18.0749), 500)
    }
    ...
    func testHuntContractSupportsNoVoucher() throws {
        let data=Data(#"{"id":"h","expires":1900000000,"completed":null,"collected":["s"],"voucher":null}"#.utf8)
